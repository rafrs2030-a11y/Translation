...
var require_middleware = __commonJS({
  ".next/server/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[751], { 42: (a) => {
      ...
      "use strict";
      let d, e, f;
      c.r(b), c.d(b, { default: () => cs, handler: () => cr });
      var g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v = {};
      async function w() {
        return "_ENTRIES" in globalThis && _ENTRIES.middleware_instrumentation && await _ENTRIES.middleware_instrumentation;
      }
      c.r(v), c.d(v, { config: () => cl, middleware: () => ck });
      let x = null;
      async function y() {
...
Learn More: https://nextjs.org/docs/messages/node-module-in-edge-runtime`;
  ...
  `);
      ...
      let cl = { matcher: ["/((?!_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)"] };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let cm = { ...v }, cn = "/middleware", co = (0, cm.middleware || cm.default);
      class cp extends Error {
        constructor(a10) {
          super(a10), this.stack = "";
        }
      }
      if ("function" != typeof co) throw new cp(`The Middleware file "${cn}" must export a function named \`middleware\` or a default function.`);
      let cq = (a10) => bG({ ...a10, IncrementalCache: ci, incrementalCacheHandler: null, page: cn, handler: async (...a11) => {
        try {
          return await co(...a11);
        } catch (e2) {
      ...
      async function cr(a10, b10) {
        let c2 = await cq({ request: { url: a10.url, method: a10.method, headers: N(a10.headers), nextConfig: { basePath: "", i18n: "", trailingSlash: false, experimental: { cacheLife: { default: { stale: 300, revalidate: 900, expire: 4294967294 }, seconds: { stale: 30, revalidate: 1, expire: 60 }, minutes: { stale: 300, revalidate: 60, expire: 3600 }, hours: { stale: 300, revalidate: 3600, expire: 86400 }, days: { stale: 300, revalidate: 86400, expire: 604800 }, weeks: { stale: 300, revalidate: 604800, expire: 2592e3 }, max: { stale: 300, revalidate: 2592e3, expire: 31536e3 } }, authInterrupts: false, clientParamParsingOrigins: [] } }, page: { name: cn }, body: "GET" !== a10.method && "HEAD" !== a10.method ? a10.body ?? void 0 : void 0, waitUntil: b10.waitUntil, requestMeta: b10.requestMeta, signal: b10.signal || new AbortController().signal } });
...
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/middleware.js"], "entrypoint": "server/middleware.js", "name": "middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?(?:\\/((?!_next\\/static|_next\\/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*))(\\.json)?[\\/#\\?]?$", "originalSource": "/((?!_next/static|_next/image|favicon.ico|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "2sTGZg1MsmNUTV8kDOYkn", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "6JayUTSXnZPslDCyKMgaPF4WxvHm6+wQhPqkw0kKPWE=", "__NEXT_PREVIEW_MODE_ID": "ae096cacf228e90707bc28729bf6a35a", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "0dd875593f290717a661c5e5ceac6dade3dd1ed0997fb11bafaf5855c9b61258", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "0971e75eb2bf599c800f69443f855ed00fd3173ff925cac9eef96659348b8f01" } } }, "functions": {}, "sortedMiddleware": ["/"] };
